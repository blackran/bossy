...
function EditNiveau(props) {
    ...
    const getNiveau = (_id) => {
        axios
            .get(`${process.env.REACT_APP_API}/api/niveau/${_id}`)
            .then(({ data }) => {
                const newstate = {
    ...
    const handleSubmit = event => {
        ...
        axios
            ...
            .patch(
                `${process.env.REACT_APP_API}/api/niveau/${props.id}`, { niveau }
            ...
            .then(response => {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Bonne travail',
                    text: 'Vous avez modifié avec succès une nouvelle niveau!'
                })
            })
            .catch(error => {
                console.log(error);
            ...
            <div className="modal-dialog modal-dialog-scrollable" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h4 className="modal-title" id="myModalLabel1">Formulaire pour modifier le niveau</h4>
