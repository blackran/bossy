...
function AddType(props) {
    ...
    const handleSubmit = event => {
        ...
        axios
            ...
            .post(
                `${process.env.REACT_APP_API}/api/type`, { type }
            ...
            .then(response => {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Bonne travail',
                    text: 'Vous avez ajouté avec succès une nouvelle type!'
                })
            })
            .catch(error => {
                Swal.fire({
            ...
            <div className="modal-dialog modal-dialog-scrollable" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h4 className="modal-title" id="myModalLabel1">Formulaire pour ajouter le type</h4>
